<template>
        <div>
            ...
            <div class="form-group row">
                <label for="path" class="col-sm-2 col-form-label">Imágen Banner</label>
                <div class="col-sm-10">
                    <div class="form-group" id="path">
                        <input @change="getImage" accept=".png, .jpeg, .jpg" type="file" name="path" class="form-control-file">
                    </div>  
                </div>
            </div>
        </div>     
    ...
    export default {
        ...
        methods:{
            getPostImage(){
                ...
                axios.get('/admin/banners/'+id[0]+'/image').then(res =>{
