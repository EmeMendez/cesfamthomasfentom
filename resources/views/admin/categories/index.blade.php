...
<div class="container mb-5">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header"><h4 class="mb-0 text-secondary">Lista de categorías</h4></div>

                <div class="card-body">
                  <a href="{{route('admin.categories.create')}}"><button class="btn btn-success mb-3">Crear nueva +</button></a>
                    @if (session('status'))
                      ...
                      <div class="row">
                        ...
                        <div class="col-12 col-md-4 mb-2 mb-md-0 my-3 my-md-0 ">
                          <select name="category_status" class="form-control" id="status">
                            ...
                            <option @if(old('category_status',$category_status) == 'ACTIVE') selected @endif value="ACTIVE">Activos</option>
                            <option @if(old('category_status',$category_status) == 'DELETED') selected @endif value="DELETED">Eliminados</option>
                          </select>         
                        </div>
                        ...
                        <div class="col-6 col-md-1 pl-0 pl-md-3">
                          <a class="text-white" href="{{route('admin.categories.index')}}">
                  ...
                  {{-- end search --}}
                    ...
                    <div>
                    <p class="text-secondary my-2">Resuldados  @if($name) para <b>{{$name}}</b>  @endif() : [ {{$categories->total()}} ] </p>     
                    {{-- start table --}}
                        ...
                        <table class="table table-striped">
                          ...
                          <tbody class="text-secondary">
                            ...
                            <tr>
                              ...
                              <x-admin.tables.actionbuttons :model="$category" :group="'categories'"></x-admin.tables.actionbuttons>
