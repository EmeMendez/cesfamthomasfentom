                    ...
                    <form action="{{route('admin.tags.index')}}" method="GET">
                      <div class="row">
                        ...
                        <div class="col-12 col-md-4 mb-2 mb-md-0 my-3 my-md-0 ">
                          <select name="tag_status" class="form-control" id="status">
                            <option selected disabled value="">--Seleccione estado--</option>
                            <option @if(old('tag_status',$tag_status) == 'ACTIVE') selected @endif value="ACTIVE">Activos</option>
                            <option @if(old('tag_status',$tag_status) == 'DELETED') selected @endif value="DELETED">Eliminados</option>
                          </select>         
                        </div>
                        ...
                        <div class="col-6 col-md-1 pl-0 pl-md-3">
                          <a class="text-white" href="{{route('admin.tags.index')}}">
                        ...
                        <table class="table table-striped">
                          ...
                          <tbody class="text-secondary">
                            ...
                            <tr>
                              ...
                              <x-admin.tables.actionbuttons :model="$tag" :group="'tags'"></x-admin.tables.actionbuttons>
                            </tr>
                          @endforeach
                          </tbody>
                        </table>
