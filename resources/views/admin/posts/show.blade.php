        ...
        <div class="card px-5">
            ...
            <div class="row">
                <a href="#modal_image" data-toggle="modal" data-target="#modal_image">
                    <img src="/{{$post->image}}" class="px-4 pb-3 pt-1" width="800" height="300" alt="">
                </a>
...
<!-- Button trigger modal -->
  ...
  <div class="modal fade col-12" id="modal_image" tabindex="-1" role="dialog" aria-labelledby="modal_imageTitle" aria-hidden="true">
      <button type="button" class="close" style="position:-50%" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
    <div class="modal-dialog modal-dialog-centered p-0 m-0 my-3 ml-3" role="document">
        
        <div class="text-center">
            <img src="/{{$post->image}}" class="rounded"  alt="">
        </div>
